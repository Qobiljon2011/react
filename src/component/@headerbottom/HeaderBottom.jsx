  ...
  return (
    <div className="w-[100%] h-[400px] all flex items-end justify-center all">
      <div className="w-[64%] h-[80%] flex flex-col items-center justify-between">
        ...
        <div
          className="w-[100%] h-[50%] flex justify-center items-center border-2 logos"
          ref={containerRef}
        >
          <div
          ...
          >
            {cryptoData.concat(cryptoData).map((item, index) => (
              <div
                key={index}
                className="w-[2%] h-[100%] flex flex-col justify-between items-center logos-slide-img border-2"
                style={{ flexShrink: 0 }}
              >
                <div className="w-[80px] h-[80px] border-2">
                  <img
                    src={item.image}
                    alt={item.name}
                ...
                <div className="w-[100px] h-[50px] border-2 flex flex-col items-center">
